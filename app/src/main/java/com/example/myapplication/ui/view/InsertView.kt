...
import com.example.myapplication.ui.viewmodel.FormState
import com.example.myapplication.ui.viewmodel.InsertUiState
...
fun InsertMhsView(
    ...
    viewModel: InsertViewModel = androidx.lifecycle.viewmodel.compose.viewModel(factory = PenyediaViewModel.Factory)
){
    val uiState = viewModel.uiState // State utama uuntuk loading, Success, Error
        ...
        when (uiState) {
            is FormState.Success -> {
                ...
                coroutineScope.launch {
                    snackbarHostState.showSnackbar(uiState.message)//tampilkan snakcbar
                }
                delay(700)
